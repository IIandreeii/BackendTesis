...
export const generateReport = async (req, res, period) => {
    ...
    try {
        ...
        worksheet.addRow([]);
        const headerRow = worksheet.addRow(['ID Donante', 'Donante', 'Monto', 'Estado', 'Método de Pago', 'Fecha de Pago']);
        ...
        donations.forEach((donation, index) => {
            const row = worksheet.addRow([
                donation.userId, // Asumiendo que tienes el ID del usuario en donation.userId
                donation.donorName,
                donation.amount,
